...
export const ONBOARDING_SECTIONS: OnboardingSection[] = [
  ...
  },
  {
    ...
    description: "Infrastructure, integrations, and how people will find you after launch.",
    questions: [
      {
        id: "domainStatus",
      ...
      },
      {
        ...
        placeholder: "Paste links for each platform you use or plan to use.",
      },
      {
        id: "socialPageSetup",
        label: "Do you need social media pages set up for your brand?",
        type: "select",
        group: "Social & marketing",
        helpText:
          "We can create or optimize profiles (bio, links, branding, highlights) so your social front matches your website.",
        options: [
          "Yes — create pages from scratch (I don't have them yet)",
          "Yes — professional setup / refresh of existing pages",
          "No — I already manage my social pages",
          "Not sure — tell me what's included",
        ],
      },
      {
        id: "socialPlatformsSetup",
        label: "Which platforms should we set up or manage?",
        type: "checkbox-group",
        group: "Social & marketing",
        helpText: "Select all that apply — available with project launch or on a monthly retainer.",
        options: [
          "Instagram",
          "Facebook",
          "LinkedIn",
      ...
      },
      {
        ...
        type: "checkbox-group",
        group: "Social & marketing",
        helpText: "Social, content, and IT support are included on the $400/mo retainer.",
        options: [
...
export const STORAGE_KEY = "showme-onboarding-draft-v7";
